...
const PRODUCT_GROUPS: Record<string, string[]> = {
  ...
  "파인트": [
    "딸기파인트", "말차파인트", "망고요거트파인트", "민트초코파인트", "바닐라빈파인트",
    "복숭아요거트파인트", "생요거트파인트", "생우유파인트", "저당 초콜릿 파인트",
    "초코파인트", "치즈케이크파인트",
  ],
  "모나카": ["옥수수모나카", "저당 꿀고구마 모나카", "저당 생우유 모나카"],
  "요거트바": ["딸기요거트바", "딸기생요거트바", "블루베리생요거트바", "복숭아요거트바", "애플망고요거트바"],
};
