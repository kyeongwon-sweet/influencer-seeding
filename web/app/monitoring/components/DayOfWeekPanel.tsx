...
export type DowData = { label: string; count: number; median: number }[];
  ...
  return (
    <div className="px-6 pb-5 pt-4 border-t border-a-hairline">
      ...
      <div className="text-[12px] text-a-ink-muted mb-3 leading-relaxed">
        게시물을 <b className="text-a-ink">올린 요일</b>로 묶어 각 영상의 <b className="text-a-ink">게시 후 7일 시점 조회수 중앙값</b>을 비교합니다.
        일별 증분과 달리 수집 누락·백로그에 흔들리지 않아 &quot;언제 올릴까&quot; 판단에 적합합니다. (표본 {totalN}개)
      </div>
      {totalN === 0 ? (
