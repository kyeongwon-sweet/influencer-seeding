...
// 🔒 배너 도달수=조회수 회귀 테스트 (2026-07-13: 저장은 reach로 옮겼는데 표시가 play를 읽어 도달수 열이 '—'가 되던 버그)
// 배너 지표 = reach 우선, 없으면 입력값(play) 1:1. 모든 표시·집계 경로가 이 규칙 하나만 사용.
test("bannerDailyMetric: reach 우선, 없으면 play 폴백, 둘 다 없으면 null", () => {
