...
def test_target_measured_at_uses_base_date_for_ended_posts():
...
def test_base_date_metric_satisfies_ended_post():
    post = {"id": "p1", "ended_at": "2026-07-07"}
    assert has_exportable_metric(post, {"p1": [BASE_MEASURED_AT]})
