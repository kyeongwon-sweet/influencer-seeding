/**
 * ═══════════════════════════════════════════════════════════════
 * 마케팅 대시보드 - KPI 자동 전송 (Google Apps Script)
 * ═══════════════════════════════════════════════════════════════
 *
 * 기능:
 * - Google Sheets의 KPI 데이터를 Vercel 앱으로 자동 전송
 * - Custom Menu로 수동 트리거 (버튼처럼 사용)
 * - 매일 자동 실행 (트리거 설정 필요)
...
function pushKpi() {
  try {
    ...
    Logger.log(`[SHEET] 현재 시트: ${SpreadsheetApp.getActiveSheet().getName()}`);
...
function previewKpiData() {
  try {
    ...
    const output = `
[미리보기]
시트: ${SpreadsheetApp.getActiveSheet().getName()}
월: ${data.monthLabel}
...
// ═══════════════════════════════════════════════════════════════
// 📋 Custom Menu (Google Sheets UI - 버튼처럼 사용!)
// ═══════════════════════════════════════════════════════════════
